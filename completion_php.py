# Copyright (C) 2008 Marco Vito Moscaritolo
#
...
class CompletionPHPWindow(gtk.Window):
...
class CompletionPHPPlugin(gedit.Plugin):
    ...
    def __init__(self):
        ...
        self._all_words = {} # 'function 1', 'function 2', 'other func 1', 'other func 2'}
    ...
    def _scan_document(self, doc):
        ...
        # Load text from file
        in_file = open(self._function_definition_file,"r")
        text = in_file.read()
        in_file.close()
        # Add aviable function into hash
        self._all_words[doc] = frozenset(text.splitlines())
